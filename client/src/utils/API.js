...
export default {
    ...
    getCharityMatch: function(charityMatch){
        ...
        console.log("axios call - ","https://api.data.charitynavigator.org/v2/Organizations?app_id=46fc4448&app_key=48a6c5df025084b4eaeff36b628adb6e&pageSize=10&categoryID=" + charityMatch.question1 +"&fundraisingOrgs="+charityMatch.question2+"&scopeOfWork="+ charityMatch.question3 +"&noGovSupport="+ charityMatch.question4);
